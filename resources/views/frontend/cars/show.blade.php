...
@section('title', $car->name . ' - ' . \App\Models\Setting::get('site_name', 'Rent Travel'))
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
                ...
                <div data-aos="fade-right">
                    <div
                        ...
                        <img src="{{ $car->getFirstMediaUrl('cars') ?: 'https://images.unsplash.com/photo-1542282088-fe8426682b8f?auto=format&fit=crop&q=80&w=1200' }}"
                            class="w-full h-full object-cover" alt="{{ $car->name }}">
                    </div>
                    <div class="grid grid-cols-4 gap-4 sm:gap-6">
                        @foreach ($car->getMedia('cars') as $media)
                            <div
                                class="rounded-2xl overflow-hidden cursor-pointer aspect-square shadow-sm border border-transparent hover:border-[#D4AF37] transition-all duration-500 hover:scale-105">
                                <img src="{{ $media->getUrl() }}" class="w-full h-full object-cover" alt="Gallery">
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div data-aos="fade-left">
                    ...
                    <div class="space-y-6 pt-6" x-data="{ bookingModalOpen: {{ $errors->any() ? 'true' : 'false' }} }">
                        ...
                        <div class="flex items-center justify-center gap-2">
                            ...
                            <p class="text-slate-400 text-[10px] font-bold uppercase tracking-widest text-center">Butuh
