...
@section('title', $tourPackage->name . ' - ' . \App\Models\Setting::get('site_name', 'Rent Travel'))
...
@section('content')
    ...
    <section class="pb-24 bg-white relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-16 lg:gap-24 items-start">
                <div class="lg:col-span-2 space-y-16">
                    <div class="relative h-[32rem] rounded-[3.5rem] overflow-hidden shadow-[0_40px_100px_-30px_rgba(0,0,0,0.15)] group"
                        data-aos="zoom-in">
                        ...
                        <div class="absolute bottom-12 left-12 right-12 text-white">
                            <div
                                class="inline-flex items-center gap-3 px-4 py-2 rounded-xl bg-amber-50/20 backdrop-blur-xl border border-amber-200/30 gold-gradient-text font-black text-[10px] uppercase tracking-[0.3em] mb-6 shadow-sm shadow-amber-900/5">
                                {{ strtoupper($tourPackage->duration) }} • STANDAR EMAS
                            </div>
                            <h1 class="text-4xl md:text-6xl font-black font-heading tracking-tighter leading-[0.9]">
                                {{ $tourPackage->name }}</h1>
                        </div>
                    </div>
                                    ...
                                    <div
                                        ...
                                        @foreach ($tourPackage->itinerary as $item)
                                            <div class="relative pl-12">
                                                <div
                                                    class="absolute left-0 top-1.5 w-6 h-6 rounded-full bg-white border-2 border-gold flex items-center justify-center z-10">
                ...
                <div class="lg:col-span-1" data-aos="fade-left">
                    <div
                        class="bg-white border border-slate-100 p-12 rounded-[3.5rem] shadow-[0_40px_100px_-30px_rgba(0,0,0,0.15)] sticky top-32">
                        ...
                        <p class="text-slate-400 text-xs font-medium mb-12 leading-relaxed italic">"Dapatkan layanan
                            penjemputan premium dan driver berpengalaman untuk perjalanan Anda."</p>
                                ...
                                <div
                                    ...
                                    <div x-show="bookingModalOpen" x-transition:enter="ease-out duration-300"
                                        ...
                                        <form action="{{ route('bookings.store') }}" method="POST" class="space-y-6">
                                            ...
                                            <div class="space-y-2">
                                                <label
                                                    class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">Tanggal
                                                    Perjalanan</label>
                                                <div class="relative group/input">
                                                    <div
