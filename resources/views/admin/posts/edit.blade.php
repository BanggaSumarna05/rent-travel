        ...
        <div>
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    ...
                    <p class="text-slate-500 font-semibold mt-1">Sesuaikan konten post atau artikel Anda.</p>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 gap-10">
                    ...
                    <div class="space-y-4">
                        ...
                        <textarea name="content" rows="12" required
                            ...
                            placeholder="Isi post...">{{ old('content', $post->content) }}</textarea>
                        @error('content')
                            <p class="text-xs text-red-500 font-bold ml-4">{{ $message }}</p>
                        @enderror
                    </div>
                            ...
                            <div class="relative group">
                                ...
                                <label for="imageInput"
                                    ...
                                    <div id="previewContainer"
                                        class="{{ $post->hasMedia('posts') ? '' : 'hidden' }} w-full mb-4 text-center">
                                        <img id="imagePreview" src="{{ $post->getFirstMediaUrl('posts') }}" alt="Preview"
                                            class="w-full h-48 object-cover rounded-2xl shadow-lg inline-block">
                                    </div>
                                    <div id="uploadPlaceholder"
                                        class="{{ $post->hasMedia('posts') ? 'hidden' : '' }} flex flex-col items-center">
                                        <div
                                            class="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center text-slate-400 mb-4 group-hover:scale-110 group-hover:bg-white group-hover:text-teal-500 transition-all duration-500 text-center">
                        ...
                        <div class="space-y-10">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center gap-6 p-6 bg-slate-50 rounded-3xl">
                                    ...
                                    <span class="text-sm font-black text-slate-700 uppercase tracking-widest">Publish
                                        SeKarang</span>
                                </div>
                            </div>
    ...
    <script>
        function previewImage(event) {
            ...
            reader.onload = function() {
                ...
                document.getElementById('changeHint').classList.remove('hidden');
            }
