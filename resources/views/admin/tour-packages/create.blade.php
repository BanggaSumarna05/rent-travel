                ...
                <div class="space-y-10">
                    <div class="space-y-4">
                        ...
                        <textarea name="description" rows="4"
                            ...
                            placeholder="Jelaskan gambaran umum perjalanan..." required>{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-[10px] font-black uppercase tracking-widest ml-4 mt-2">
                                {{ $message }}</p>
                        @enderror
                    ...
                    <!-- Itinerary Section -->
                    <div class="space-y-6" x-data="{ items: {{ old('itinerary') ? json_encode(old('itinerary')) : '[]' }} }">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div class="space-y-4">
                            ...
                            <textarea name="include" rows="6"
                                ...
                                placeholder="Satu fasilitas per baris...">{{ old('include') }}</textarea>
                        </div>
                        <div class="space-y-4">
                            ...
                            <textarea name="exclude" rows="6"
                                ...
                                placeholder="Satu fasilitas per baris...">{{ old('exclude') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
